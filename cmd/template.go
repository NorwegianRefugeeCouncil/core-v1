...
to quickly create a Cobra application.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		individual := &api.Individual{
			...
			HasCognitiveDisability:        enumTypes.NewBool(true),
			HasCommunicationDisability:    enumTypes.NewBool(true),
			HasConsentedToRGPD:            enumTypes.NewBool(true),
			HasConsentedToReferral:        nil,
			HasDisability:                 enumTypes.NewBool(false),
			HasHearingDisability:          enumTypes.NewBool(false),
			HasMobilityDisability:         enumTypes.NewBool(false),
			HasSelfCareDisability:         enumTypes.NewBool(false),
			...
			IsHeadOfCommunity:       enumTypes.NewBool(false),
			IsHeadOfHousehold:       enumTypes.NewBool(true),
			IsFemaleHeadedHousehold: enumTypes.NewBool(false),
			IsMinorHeadedHousehold:  enumTypes.NewBool(false),
			IsMinor:                 enumTypes.NewBool(false),
			...
			PrefersToRemainAnonymous:       enumTypes.NewBool(false),
			PresentsProtectionConcerns:     enumTypes.NewBool(false),
			PWDComments:                    "",
