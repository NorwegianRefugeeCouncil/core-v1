...
func (i *Individual) unmarshalTabularData(colMapping map[string]int, cols []string) error {
	...
	for field, idx := range colMapping {
		...
		case constants.FileColumnIndividualBirthDate:
			if i.BirthDate, err = ParseDate(cols[idx]); err != nil {
				return err
			}
		case constants.FileColumnIndividualCognitiveDisabilityLevel:
			if i.CognitiveDisabilityLevel, err = ParseDisabilityLevel(cols[idx]); err != nil {
				return err
			}
		...
		case constants.FileColumnIndividualCollectionAgentID:
			i.CollectionAgentID = cols[idx]
		case constants.FileColumnIndividualCollectionTime:
			if i.CollectionTime, err = ParseDate(cols[idx]); err != nil {
				return err
			}
		case constants.FileColumnIndividualCommunicationDisabilityLevel:
			if i.CommunicationDisabilityLevel, err = ParseDisabilityLevel(cols[idx]); err != nil {
				return err
			}
		...
		case constants.FileColumnIndividualHearingDisabilityLevel:
			if i.HearingDisabilityLevel, err = ParseDisabilityLevel(cols[idx]); err != nil {
				return err
			}
		...
		case constants.FileColumnIndividualIsActive:
			i.IsActive = isTrue(cols[idx])
		...
		case constants.FileColumnIndividualMobilityDisabilityLevel:
			if i.MobilityDisabilityLevel, err = ParseDisabilityLevel(cols[idx]); err != nil {
				return err
			}
		...
		case constants.FileColumnIndividualRecordedAge:
			if i.RecordedAge, err = strconv.Atoi(cols[idx]); err != nil {
				return err
			}
		case constants.FileColumnIndividualSelfCareDisabilityLevel:
			if i.SelfCareDisabilityLevel, err = ParseDisabilityLevel(cols[idx]); err != nil {
				return err
			}
		...
		case constants.FileColumnIndividualVisionDisabilityLevel:
			if i.VisionDisabilityLevel, err = ParseDisabilityLevel(cols[idx]); err != nil {
				return err
			}
		}
	}
