...
type Individual struct {
	...
	CognitiveDisabilityLevel DisabilityLevel `db:"cognitive_disability_level"`
	...
	CollectionAdministrativeArea1 string `db:"collection_administrative_area_1"`
	...
	CollectionAdministrativeArea2 string `db:"collection_administrative_area_2"`
	...
	CollectionAdministrativeArea3 string `db:"collection_administrative_area_3"`
	// CollectionAgentID is the ID of the agent who collected the data
	CollectionAgentID string `db:"collection_agent_id"`
	...
	CommunicationDisabilityLevel DisabilityLevel `db:"communication_disability_level"`
	...
	IdentificationType1 string `db:"identification_type_1"`
	...
	IdentificationTypeExplanation1 string `db:"identification_type_explanation_1"`
	// IdentificationNumber1 is the primary identification number of the individual
	IdentificationNumber1 string `db:"identification_number_1"`
	// IdentificationType2 is the type of secondary identification of the individual
	IdentificationType2 string `db:"identification_type_2"`
	...
	IdentificationTypeExplanation2 string `db:"identification_type_explanation_2"`
	// IdentificationNumber2 is the secondary identification number of the individual
	IdentificationNumber2 string `db:"identification_number_2"`
	// IdentificationType3 is the type of tertiary identification of the individual
	IdentificationType3 string `db:"identification_type_3"`
	...
	IdentificationTypeExplanation3 string `db:"identification_type_explanation_3"`
	// IdentificationNumber3 is the tertiary identification number of the individual
	IdentificationNumber3 string `db:"identification_number_3"`
	// IdentificationContext is the context of the identification of the individual
	IdentificationContext string `db:"identification_context"`
	...
	MobilityDisabilityLevel DisabilityLevel `db:"mobility_disability_level"`
	// Nationality1 is the primary nationality of the individual
	Nationality1 string `db:"nationality_1"`
	// Nationality2 is the secondary nationality of the individual
	Nationality2 string `db:"nationality_2"`
	...
	PreferredContactMethodComments string `db:"preferred_contact_method_comments"`
	...
	PreferredCommunicationLanguage string `db:"preferred_communication_language"`
	// PrefersToRemainAnonymous is a flag indicating whether the individual prefers to remain anonymous
	PrefersToRemainAnonymous bool `db:"prefers_to_remain_anonymous"`
	...
	// RecordedAge is the recorded age of the individual by the agent.
	// This is used when the BirthDate is not known
	// TODO: verify recorded age vs birth_date. Perhaps include a flag indicating whether the birth date is known
	RecordedAge int `db:"recorded_age"`
	// SelfCareDisabilityLevel is the self-care disability level of the individual
	SelfCareDisabilityLevel DisabilityLevel `db:"selfcare_disability_level"`
	// SpokenLanguage1 is the primary spoken language of the individual
	SpokenLanguage1 string `db:"spoken_language_1"`
	// SpokenLanguage2 is the secondary spoken language of the individual
	SpokenLanguage2 string `db:"spoken_language_2"`
	// SpokenLanguage3 is the tertiary spoken language of the individual
	SpokenLanguage3 string `db:"spoken_language_3"`
	...
	VisionDisabilityLevel DisabilityLevel `db:"vision_disability_level"`
}
...
func (i *Individual) GetFieldValue(field string) (interface{}, error) {
	...
	case constants.DBColumnIndividualCollectionAgentID:
		return i.CollectionAgentID, nil
	...
	case constants.DBColumnIndividualIsActive:
	...
	case constants.DBColumnIndividualRecordedAge:
		return i.RecordedAge, nil
...
func (i *Individual) Normalize() {
	...
	i.CollectionAgentID = trimString(i.CollectionAgentID)
