...
type IndividualRepo interface {
	GetAll(ctx context.Context, options api.IndividualListOptions) ([]*api.Individual, error)
...
func (i individualRepo) GetAll(ctx context.Context, options api.IndividualListOptions) ([]*api.Individual, error) {
...
func (i individualRepo) batchedGetAllInternal(ctx context.Context, tx *sqlx.Tx, options api.IndividualListOptions) ([]*api.Individual, error) {
...
func (i individualRepo) unbatchedGetAllInternal(ctx context.Context, tx *sqlx.Tx, options api.IndividualListOptions) ([]*api.Individual, error) {
