...
func Test_newGetAllIndividualsSQLQuery(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND age >= $1 ORDER BY created_at`,
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND cognitive_disability_level = $1 ORDER BY created_at`,
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND collection_administrative_area_1 = $1 ORDER BY created_at`,
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND collection_administrative_area_2 = $1 ORDER BY created_at`,
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND collection_administrative_area_3 = $1 ORDER BY created_at`,
			wantArgs: []interface{}{"area3"},
		}, {
			name:     "collectionAgentName",
			args:     api.ListIndividualsOptions{CollectionAgentName: "agent"},
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND collection_agent_name = $1 ORDER BY created_at`,
			wantArgs: []interface{}{"agent"},
		}, {
			name:     "collectionAgentTitle",
			args:     api.ListIndividualsOptions{CollectionAgentTitle: "title"},
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND collection_agent_title = $1 ORDER BY created_at`,
			wantArgs: []interface{}{"title"},
		}, {
			name:     "collectionTimeFrom",
			args:     api.ListIndividualsOptions{CollectionTimeFrom: &someDate},
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND collection_time >= $1 ORDER BY created_at`,
			wantArgs: []interface{}{&someDate},
		}, {
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND community_id = $1 ORDER BY created_at`,
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND created_at >= $1 ORDER BY created_at`,
			wantArgs: []interface{}{&someDate},
		}, {
			name:     "createdAtTo",
			...
			wantSql: `SELECT * FROM individual_registrations WHERE deleted_at IS NULL ORDER BY created_at`,
		}, {
			name:     "email",
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND free_field_1 = $1 ORDER BY created_at`,
			wantArgs: []interface{}{"freeField1"},
		}, {
			name:     "freeField2",
			args:     api.ListIndividualsOptions{FreeField2: "freeField2"},
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND free_field_2 = $1 ORDER BY created_at`,
			wantArgs: []interface{}{"freeField2"},
		}, {
			name:     "freeField3",
			args:     api.ListIndividualsOptions{FreeField3: "freeField3"},
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND free_field_3 = $1 ORDER BY created_at`,
			wantArgs: []interface{}{"freeField3"},
		}, {
			name:     "freeField4",
			args:     api.ListIndividualsOptions{FreeField4: "freeField4"},
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND free_field_4 = $1 ORDER BY created_at`,
			wantArgs: []interface{}{"freeField4"},
		}, {
			name:     "freeField5",
			args:     api.ListIndividualsOptions{FreeField5: "freeField5"},
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND free_field_5 = $1 ORDER BY created_at`,
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND has_cognitive_disability = $1 ORDER BY created_at`,
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND has_communication_disability = $1 ORDER BY created_at`,
			wantArgs: []interface{}{true},
		}, {
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND has_consented_to_rgpd = $1 ORDER BY created_at`,
			wantArgs: []interface{}{true},
		}, {
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND has_consented_to_referral = $1 ORDER BY created_at`,
			wantArgs: []interface{}{true},
		}, {
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND has_hearing_disability = $1 ORDER BY created_at`,
			wantArgs: []interface{}{true},
		}, {
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND has_mobility_disability = $1 ORDER BY created_at`,
			wantArgs: []interface{}{true},
		}, {
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND has_selfcare_disability = $1 ORDER BY created_at`,
			wantArgs: []interface{}{true},
		}, {
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND has_vision_disability = $1 ORDER BY created_at`,
			wantArgs: []interface{}{true},
		}, {
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND hearing_disability_level = $1 ORDER BY created_at`,
			wantArgs: []interface{}{"mild"},
		}, {
			name:     "householdId",
			args:     api.ListIndividualsOptions{HouseholdID: "household-id"},
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND household_id = $1 ORDER BY created_at`,
			wantArgs: []interface{}{"household-id"},
		}, {
			name:     "id (single)",
			args:     api.ListIndividualsOptions{IDs: containers.NewStringSet("1")},
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND id IN ($1) ORDER BY created_at`,
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND (identification_number_1 = $1 OR identification_number_2 = $1 OR identification_number_3 = $1) ORDER BY created_at`,
			wantArgs: []interface{}{"123456789"},
		}, {
			name:     "identificationContext",
			args:     api.ListIndividualsOptions{IdentificationContext: "context"},
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND identification_context = $1 ORDER BY created_at`,
			wantArgs: []interface{}{"context"},
		}, {
			name:     "internalID",
			args:     api.ListIndividualsOptions{InternalID: "internal-id"},
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND internal_id = $1 ORDER BY created_at`,
			wantArgs: []interface{}{"internal-id"},
		}, {
			name:     "isHeadOfCommunity",
			args:     api.ListIndividualsOptions{IsHeadOfCommunity: pointers.Bool(true)},
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND is_head_of_community = $1 ORDER BY created_at`,
			wantArgs: []interface{}{true},
		}, {
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND is_head_of_household = $1 ORDER BY created_at`,
			wantArgs: []interface{}{true},
		}, {
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND mobility_disability_level = $1 ORDER BY created_at`,
			wantArgs: []interface{}{"mild"},
		}, {
			name:     "nationality",
			args:     api.ListIndividualsOptions{Nationality: "nationality"},
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND (nationality_1 = $1 OR nationality_2 = $1) ORDER BY created_at`,
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND preferred_contact_method = $1 ORDER BY created_at`,
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND preferred_communication_language = $1 ORDER BY created_at`,
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND prefers_to_remain_anonymous = $1 ORDER BY created_at`,
			wantArgs: []interface{}{true},
		}, {
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND selfcare_disability_level = $1 ORDER BY created_at`,
			wantArgs: []interface{}{"mild"},
		}, {
			name:     "spokenLanguage",
			args:     api.ListIndividualsOptions{SpokenLanguage: "language"},
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND (spoken_language_1 = $1 OR spoken_language_2 = $1 OR spoken_language_3 = $1) ORDER BY created_at`,
			wantArgs: []interface{}{"language"},
		}, {
			name:     "updatedAtFrom",
			args:     api.ListIndividualsOptions{UpdatedAtFrom: pointers.Time(time.Date(2020, 1, 1, 0, 0, 0, 0, time.UTC))},
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND updated_at >= $1 ORDER BY created_at`,
			...
			wantSql:  `SELECT * FROM individual_registrations WHERE deleted_at IS NULL AND vision_disability_level = $1 ORDER BY created_at`,
			wantArgs: []interface{}{"mild"},
		}, {
			name:    "skip",
			...
			wantSql: `SELECT * FROM individual_registrations WHERE deleted_at IS NULL ORDER BY created_at OFFSET 10 LIMIT 10`,
		},
	}
