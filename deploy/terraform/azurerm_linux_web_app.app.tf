resource "azurerm_linux_web_app" "app" {
  ...
  app_settings = {
    ...
    CORE_HASH_KEY_1  = base64encode(local.current_hash_key)
    CORE_BLOCK_KEY_1 = base64encode(local.current_block_key)
    CORE_HASH_KEY_1  = base64encode(local.old_hash_key)
    CORE_BLOCK_KEY_1 = base64encode(local.old_block_key)
