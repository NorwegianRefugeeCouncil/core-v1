...
generate: prerequisites
	...
	protoc --plugin=./web/proto/node_modules/.bin/protoc-gen-ts_proto -I=./proto --ts_proto_opt=useReadonlyTypes=true --ts_proto_out=./web/proto/ ./proto/forms.proto
	protoc --plugin=./web/proto/node_modules/.bin/protoc-gen-ts_proto -I=./proto --ts_proto_opt=useReadonlyTypes=true --ts_proto_out=./web/proto/ ./proto/forms_service.proto
	protoc --plugin=./web/proto/node_modules/.bin/protoc-gen-ts_proto -I=./proto --ts_proto_opt=useReadonlyTypes=true --ts_proto_out=./web/proto/ ./proto/predicates.proto
	@go generate ./...
	@go fix ./...
